...
<body>
    <h1>General Echo - Python</h1>

    <h2>Submit Data</h2>
    <form action="general-echo-python.py" method="POST">
...
if form.keys():
    ...
    print("<table border='1' cellpadding='5'>")
    print(f"<tr><td><b>Method</b></td><td>{method}</td></tr>")
    ...
    print(f"<tr><td><b>Content Type</b></td><td>{os.environ.get('CONTENT_TYPE', 'N/A')}</td></tr>")
    print("</table>")
